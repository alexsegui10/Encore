...
var ue = (e = {}, t, r, s4) => {
  if (t) {
    ...
    return s4 === "value" || a(s4) && l === "strict" ? S.getTokenValue(t) : Y2(o, void 0, n, [i2.excludedKeyRegex], r);
  }
  return "";
};
function ar(e, ...t) {
...
function de(e, t = {}) {
  ...
  for (; o.length; ) {
    ...
    for (let u in m2) {
      let g = m2[u], f2 = ve(g), p2 = z2(u, a2) ? Q2(d) : Q2(d, ee(u));
      if (i(f2)) o.push({ node: f2, path: p2 });
      else {
        let y = ae(p2), R2 = Y2(f2, p2, s4, [a2]);
        Re(l, y, R2);
        let T = p2;
...
var b2 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s2(t) && r.transform !== "strict") {
    let y = e.replace("-directive", ""), m2 = t, { colorScheme: R2, extend: T, css: j } = m2, O2 = v2(m2, ["colorScheme", "extend", "css"]), d = T || {}, { colorScheme: M } = d, z3 = v2(d, ["colorScheme"]), u = R2 || {}, { dark: V } = u, L = v2(u, ["dark"]), g = M || {}, { dark: te } = g, re = v2(g, ["dark"]), K2 = s2(O2) ? this._toVariables({ [y]: h(h({}, O2), z3) }, r) : {}, A2 = s2(L) ? this._toVariables({ [y]: h(h({}, L), re) }, r) : {}, X = s2(V) ? this._toVariables({ [y]: h(h({}, V), te) }, r) : {}, [G2, U2] = [(f2 = K2.declarations) != null ? f2 : "", K2.tokens || []], [B, I] = [(x2 = A2.declarations) != null ? x2 : "", A2.tokens || []], [H, W2] = [(p2 = X.declarations) != null ? p2 : "", X.tokens || []], q2 = this.transformCSS(y, `${G2}${B}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y, H, "dark", "variable", r, i2, a2, n);
  ...
  let a2 = function(l, o = {}, c = []) {
    ...
    Object.entries(l).forEach(([m2, d]) => {
      let u = z2(m2, t.variable.excludedKeyRegex) ? o : o ? `${o}.${oe(m2)}` : oe(m2), g = c ? `${c}.${m2}` : m2;
  ...
  if (s2(t)) {
    ...
    if (s4 !== "style") {
      ...
      t = r === "dark" ? c.reduce((m2, { type: d, selector: u }) => (s2(u) && (m2 += u.includes("[CSS]") ? u.replace("[CSS]", t) : this.getSelectorRule(u, l, d, t)), m2), "") : C2(l != null ? l : ":root,:host", t);
    }
    if (o) {
